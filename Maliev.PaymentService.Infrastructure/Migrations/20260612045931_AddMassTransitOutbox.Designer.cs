...
namespace Maliev.PaymentService.Infrastructure.Migrations
{
    ...
    [Migration("20260612045931_AddMassTransitOutbox")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Maliev.PaymentService.Domain.Entities.PaymentProvider", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Maliev.PaymentService.Domain.Entities.PaymentTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Maliev.PaymentService.Domain.Entities.ProviderConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Maliev.PaymentService.Domain.Entities.RefundTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Maliev.PaymentService.Domain.Entities.TransactionLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Maliev.PaymentService.Domain.Entities.WebhookEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Maliev.PaymentService.Domain.Entities.PaymentTransaction", b =>
                {
                    b.HasOne("Maliev.PaymentService.Domain.Entities.PaymentProvider", "PaymentProvider")
                        .WithMany()
            ...
            modelBuilder.Entity("Maliev.PaymentService.Domain.Entities.RefundTransaction", b =>
                {
                    b.HasOne("Maliev.PaymentService.Domain.Entities.PaymentTransaction", "PaymentTransaction")
                        .WithMany()
                    ...
                    b.HasOne("Maliev.PaymentService.Domain.Entities.PaymentProvider", "Provider")
                        .WithMany()
            ...
            modelBuilder.Entity("Maliev.PaymentService.Domain.Entities.TransactionLog", b =>
                {
                    ...
                    b.HasOne("Maliev.PaymentService.Domain.Entities.RefundTransaction", null)
                        .WithMany("TransactionLogs")
