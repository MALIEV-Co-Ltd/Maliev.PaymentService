...
namespace Maliev.PaymentService.Infrastructure.Migrations
{
    ...
    [Migration("20260222075741_AddSlipUrlToPaymentTransaction")]
    partial class AddSlipUrlToPaymentTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Maliev.PaymentService.Core.Entities.PaymentTransaction", b =>
                {
                    ...
                    b.Property<string>("SlipBankName")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("slip_bank_name");

                    b.Property<decimal?>("SlipExtractedAmount")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("slip_extracted_amount");

                    b.Property<string>("SlipTransferDate")
                        .HasMaxLength(20)
                    ...
                    b.Property<string>("SlipVerificationNotes")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("slip_verification_notes");

                    b.Property<DateTime?>("SlipVerifiedAt")
                        .HasColumnType("timestamp with time zone")
